...
const STATISTICS: Statistic[] = [
  ...
  { label: "Study Streak", value: "7 days", icon: "star.fill", color: "#F59E0B" },
  { label: "Avg. Mastery", value: "76%", icon: "chart.bar.fill", color: "#22C55E" },
  { label: "Time Spent", value: "14.5 hrs", icon: "clock.fill", color: "#EF4444" },
];
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View className="gap-6 px-4 py-4">
          ...
          <View className="gap-2">
            ...
            <Text className="text-base text-muted">Keep up the great work! 🎉</Text>
          </View>

          {/* Statistics Grid */}
          <View className="gap-3">
            <Text className="text-lg font-semibold text-foreground">Learning Statistics</Text>
              ...
              {STATISTICS.map((stat, index) => (
                ...
                >
                  <View className="flex-row items-center justify-between mb-2">
                    <Text className="text-muted text-xs font-semibold">{stat.label}</Text>
                    <View
          ...
          <View className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-2xl p-4 border border-blue-200">
            <View className="flex-row items-center justify-between mb-3">
              <Text className="text-lg font-semibold text-foreground">Overall Mastery</Text>
          ...
          <View className="gap-3">
            <View className="flex-row items-center justify-between">
              <Text className="text-lg font-semibold text-foreground">Areas to Focus On</Text>
              <TouchableOpacity>
                ...
                >
                  <View className="flex-row items-center justify-between mb-2">
                    ...
                    <View className="bg-warning bg-opacity-20 rounded-full px-3 py-1">
                      <Text className="text-warning text-xs font-semibold">{item.mastery}%</Text>
                    </View>
                  </View>
            ...
            <View className="flex-row items-start gap-3">
              ...
              <View className="flex-1">
                ...
                <Text className="text-sm text-muted leading-relaxed mb-3">
                  Based on your progress, we recommend focusing on Algebra this week. Spend 30 minutes daily on polynomial factoring.
                </Text>
                <TouchableOpacity className="bg-success rounded-lg px-4 py-2 self-start">
                  <Text className="text-white font-semibold text-sm">Start Focused Session</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
          ...
          {/* Learning Timeline */}
          <View className="gap-3">
            <Text className="text-lg font-semibold text-foreground">This Week's Activity</Text>
            <View className="bg-surface rounded-xl p-4 border border-border">
              <View className="gap-3">
                {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((day, index) => (
                  <View key={day} className="flex-row items-center gap-2">
                    <Text className="w-10 text-sm font-semibold text-muted">{day}</Text>
          ...
          <View className="gap-3">
            ...
            <View className="flex-row gap-2">
              <View className="flex-1 bg-surface rounded-xl p-3 border border-border items-center">
                ...
                <Text className="text-xs font-semibold text-foreground text-center">7-Day Streak</Text>
              </View>
              <View className="flex-1 bg-surface rounded-xl p-3 border border-border items-center">
                <Text className="text-3xl mb-1">⭐</Text>
                <Text className="text-xs font-semibold text-foreground text-center">10 Topics</Text>
              </View>
              <View className="flex-1 bg-surface rounded-xl p-3 border border-border items-center">
                <Text className="text-3xl mb-1">🏆</Text>
                <Text className="text-xs font-semibold text-foreground text-center">80% Mastery</Text>
              </View>
            </View>
          </View>
        </View>
