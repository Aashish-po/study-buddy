...
export default function HomeScreen() {
  ...
  const handlePress = (
    screen: "chat" | "study-aids" | "progress" | "settings",
  ) => {
        ...
        <View className="gap-6">
          ...
          <View className="bg-warning bg-opacity-10 rounded-xl p-4 border border-warning border-opacity-30">
            ...
            <Text className="text-xs text-muted leading-relaxed">
              Consistency is key! Try to study for 20-30 minutes daily. Short,
              focused sessions are more effective than long cramming sessions.
            </Text>
          </View>
        </View>
      </ScrollView>
